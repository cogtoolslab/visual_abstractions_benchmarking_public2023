var jsPsychSketchpad = (function (jspsych) {
  ...
  class SketchpadPlugin {
      ...
      /// intialize display of canvas/button html
      init_display() {
          this.add_css();
          let canvas_html;
          if (this.params.canvas_shape == "rectangle") {
              canvas_html = `
        <div class="row">
        <img id='photo-prompt' src="${this.params.png_path}" alt="image">
      ...
      `;
          ...
          this.display.innerHTML = `<p id="counter" style="text-align: right; margin-bottom: 0em"> \
            Drawing: ${this.params.currentDrawing} \
            / ${this.params.totalDrawings} </p>` + display_html;
          this.sketchpad = this.display.querySelector("#sketchpad-canvas");
          this.ctx = this.sketchpad.getContext("2d");
      } // close intialize canvas/buttons html

      // track mouse & click behavior
      ...
      } // close render_drawing

      undo() {
          this.undo_history.push(this.strokes.pop());
          this.trial_undo_history = [...this.undo_history];
      ...
      end_trial(response = null) {
        ...
        //     alert("Looks like your canvas is empty! Please draw something before continuing.");
        //     return;
        // }
          ...
          trial_data.currDrawing = this.params.currentDrawing;
          trial_data.filename = this.params.filename;
          trial_data.uniqueID = this.params.uniqueID;
          trial_data.abstraction = this.params.trial_duration;
          trial_data.undo_history = this.trial_undo_history;
          trial_data.eventType = 'drawing';

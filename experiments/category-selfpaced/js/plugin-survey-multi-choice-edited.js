var jsPsychSurveyMultiChoiceEdited = (function (jspsych) {
  'use strict';
      ...
      trial(display_element, trial) {
          ...
          document.querySelector("form").addEventListener("submit", (event) => {
            ...
            var trial_data = {
                ...
                gcbID: trial.gcbID, 
                origStudy_order_num: trial.origStudy_order_num,
                origStudy: trial.origStudy, 
                origStudy_taskCategorization: trial.origStudy_taskCategorization, 
                graphType: trial.graphType, 
                questionType: trial.questionType,
                options: trial.optins,
                filename: trial.graphFilename,
                preamble: trial.preamble,
                prompt: trial.prompt,
                promptTitle: trial.promptTitle,
                triamNum: trial.trialNum
            };
